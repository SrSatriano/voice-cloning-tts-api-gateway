# Arquitetura — Gateway de API de clonagem de voz e TTS

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

API com workers horizontais, upload de WAV de referência e documentação de qualidade de áudio.
...
| Síntese | Síntese síncrona e batch assíncrono |
| Registro | Registro de vozes por upload WAV |
| Workers | Workers Redis escaláveis |
| Guia | Guia de fine-tuning |
